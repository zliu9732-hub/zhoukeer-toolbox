...
install_decky_zip_from_mirror() {
    ...
    cp -a -- "$source_dir/package.json" "$source_dir/plugin.json" "$source_dir/dist" \
...
grep -Fq 'zhoukeer-toolbox-mirror-3|SteamDB 游戏数据|steamdb-game-info-zh|f7eb84a3e2a9c41de373d4a97c1a28269378fc72de05a0c2df06aeb148ed8618|SteamDBButton' "$CALL_LOG" || \
    fail "SteamDB 未固定使用 mirror-3 分块包"
grep -Fq 'zhoukeer-toolbox-mirror-3|沉浸式翻译|decky-translator-zh|2daf88f9806c8c702e7dd149ce65a2e2199eeccb869d043416e7dca54c7704b1|decky-translator' "$CALL_LOG" || \
