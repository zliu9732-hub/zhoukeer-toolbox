...
assert_contains "$touch_plugin_page_2" 'right:17-18:tomoon' "插件第二页 ToMoon 坐标错误"
...
for file in "$MAIN_FILE" "$GUI_FILE"; do
    ...
    assert_contains "$source_text" 'modules/decky_bundle.sh" plugin "ToMoon"' "ToMoon 官方商店动作错误：$file"
