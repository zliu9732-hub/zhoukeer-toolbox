...
assert_contains "$touch_plugin_page_2" 'right:19-20:game-info-tools' "插件第二页缺少游戏数据与翻译入口"
...
assert_contains "$touch_game_info" 'right:10-11:decky-translator' "游戏数据子菜单缺少沉浸式翻译坐标"
assert_contains "$touch_game_info" 'modules/plugin_store.sh" steamdb-info' "SteamDB 菜单动作错误"
assert_contains "$touch_game_info" 'modules/plugin_store.sh" decky-translator' "沉浸式翻译菜单动作错误"
...
assert_contains "$gui_games" 'modules/plugin_store.sh" decky-translator' "GUI 沉浸式翻译菜单动作错误"
