...
assert_contains "$touch_game_info" '国内分块镜像' "游戏数据插件缺少国内分块镜像说明"
...
assert_contains "$gui_games" '国内分块镜像' "GUI 游戏数据插件缺少国内分块镜像说明"
...
assert_contains "$touch_dual" 'right:19-20:previous' "双系统更多工具页缺少上一页坐标"
assert_contains "$gui_dual" 'next "更多双系统工具' "双系统 GUI 常用工具页缺少下一页入口"
assert_contains "$gui_dual" 'previous "返回常用工具' "双系统 GUI 更多工具页缺少上一页入口"
assert_contains "$gui_dual" 'next) page=1' "双系统 GUI 下一页没有更新页码状态"
assert_contains "$gui_dual" 'previous) page=0' "双系统 GUI 上一页没有恢复页码状态"
