...
download_policy_url_allowed 'https://github.com/eugeniosegala/decky-lsfg-vk-experimental/releases/download/v0.13.0/Decky.LSFG-VK.zip' || fail "MAKO 尝鲜版 GitHub Release 被拒绝"
