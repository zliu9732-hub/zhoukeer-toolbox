            ...
            decky-install)
                ...
                case "$decky_choice" in
                    ...
                    test)
                        ...
                        ;;
                    rog-white-install)
                        gui_confirm "将 Renkit 内置的 ROG White v1.4.7 白色主题放入 CSS Loader 主题目录。需要已安装主题美化（CSS Loader），安装后请在 CSS Loader 中开启。是否继续？" && \
                    ...
                    handheld-pink-install)
                        gui_confirm "将 Renkit 内置的 Handheld Pink v1.0.2 粉色主题放入 CSS Loader 主题目录。需要已安装主题美化（CSS Loader），安装后请在 CSS Loader 中开启。是否继续？" && \
                    ...
                    pink-white-gradient-install)
                        gui_confirm "将 Renkit 内置的 Pink White Gradient v1.0.1 浅粉渐变主题放入 CSS Loader 主题目录。需要已安装主题美化（CSS Loader），安装后请在 CSS Loader 中开启。是否继续？" && \
