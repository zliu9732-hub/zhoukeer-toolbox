...
toolbox-gitee|gitee.com|Renkit版本、校验文件与固定镜像|text,sha256,tar.gz,zip,deb,AppImage|固定 main 或固定标签|SHA256+完整性校验+包内版本|1073741824|域名源→GitHub
...
clover|gitee.com|Clover 双系统引导固定资源（Gitee 来源）|tar.gz|固定版本|SHA256+完整性校验|1073741824|自有 Gitee 镜像
...
download_policy_url_allowed() {
    ...
    case "$url" in
        ...
        https://raw.githubusercontent.com/SteamDeckHomebrew/decky-loader/v3.2.8/dist/plugin_loader-release.service) return 0 ;;
        ...
        https://gitee.com/zliu9732-hub/zhoukeer-toolbox-mirror-4/*) return 0 ;;
        https://gitee.com/zliu9732-hub/zhoukeer-toolbox-mirror-5/*) return 0 ;;
...
download_policy_max_bytes() {
    case "${1%%\?*}" in
        ...
        https://gitee.com/zliu9732-hub/zhoukeer-toolbox-mirror-4/raw/main/*/latest.txt) printf '%s\n' 2097152 ;;
        https://gitee.com/zliu9732-hub/zhoukeer-toolbox-mirror-5/raw/main/*/latest.txt) printf '%s\n' 2097152 ;;
        ...
        https://gitee.com/zliu9732-hub/zhoukeer-toolbox-mirror-4/raw/main/*/part.*) printf '%s\n' 8388608 ;;
        https://gitee.com/zliu9732-hub/zhoukeer-toolbox-mirror-5/raw/main/*/part.*) printf '%s\n' 8388608 ;;
