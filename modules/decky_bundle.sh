...
DECKY_SIMPLE_TDP_URL="${ZHOUKEER_DECKY_SIMPLE_TDP_URL:-https://github.com/aarron-lee/SimpleDeckyTDP/releases/download/v1.0.7/SimpleDeckyTDP.zip}"
DECKY_SIMPLE_TDP_VERSION="${ZHOUKEER_DECKY_SIMPLE_TDP_VERSION:-v1.0.7}"
DECKY_SIMPLE_TDP_SHA256="${ZHOUKEER_DECKY_SIMPLE_TDP_SHA256:-dae7cf43ec8936c07a94a08ac418be8d9e129744a54f3aa63d2b31222bc0ad38}"
DECKY_SIMPLE_TDP_MIRROR_URL="$(gitee_mirror_direct_url simpledeckytdp v1.0.7 SimpleDeckyTDP.zip)"
