...
GE_PROTON_URL="${ZHOUKEER_GE_PROTON_URL:-${GE_PROTON_URL:-}}"
GE_PROTON_VERSION="${ZHOUKEER_GE_PROTON_VERSION:-${GE_PROTON_VERSION:-}}"
GE_PROTON_SHA256="${ZHOUKEER_GE_PROTON_SHA256:-${GE_PROTON_SHA256:-}}"
GE_PROTON_TMP_DIR=""
GE_PROTON_STAGE_DIR=""
