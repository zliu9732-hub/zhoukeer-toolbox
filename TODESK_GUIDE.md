...
ToDesk 安装过程中必须输入 SteamOS 管理员密码。**请先确认自己知道管理员密码，或者确认这台设备从未设置过管理员密码，再继续下面的教程。**从未设置过密码也可以继续，教程第 02 步会教你设置。

- **知道密码：**继续阅读下面的安装步骤。
- **从未设置过密码：**可以继续，按照第 02 步设置新密码。
- **以前设置过，但现在忘记或不知道密码：**先停止安装，[点击查看 Steam Deck 重置密码教程](https://gitee.com/zliu9732-hub/zhoukeer-toolbox/blob/main/STEAMDECK_PASSWORD_RESET_GUIDE.md)，否则操作到一半将无法完成并浪费时间。
