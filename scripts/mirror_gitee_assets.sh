...
mirror_ge_proton_latest() {
    ...
    sha256="de43c4b25f3c047db49b96c44d84759952c5a01332a68805a09e69f95dc38a75"
    if resolve_latest_github_release "GloriousEggroll/proton-ge-custom" \
        '^GE-Proton[0-9]+-[0-9]+(-x86_64)?[.]tar[.]gz$' "GE-Proton" >/dev/null 2>&1; then
...
mirror_mako_latest() {
    local version="plugin-v2.2.0"
    local file="MAKO-Decky-v2.2.0.zip"
    local url="https://github.com/eugeniosegala/MAKO/releases/download/plugin-v2.2.0/MAKO-Decky-v2.2.0.zip"
    local sha256="621ad66bd40f12b416e8112bb78e1aae55a96bf7fe14439b95fca1cf89324089"
...
inputplumber|InputPlumber|v0.79.2|inputplumber-x86_64.tar.gz|https://github.com/ShadowBlip/InputPlumber/releases/download/v0.79.2/inputplumber-x86_64.tar.gz|dc8a859b55047c1a78c99dfaa296c55eebfbf798057f519543fbc7f6215cf953|
f1-bios|飞行家 F1 V1.14 BIOS|f1-bios-v1.14|ONEXFLY-F1-7840U-BIOS-V1.14.zip|https://github.com/zliu9732-hub/zhoukeer-toolbox/releases/download/f1-bios-v1.14/ONEXFLY-F1-7840U-BIOS-V1.14.zip|32b166cf34a59220b3f8c5f9d12fc1f23348dd3af63c5b5ced6c4d5150e8d51e|
oxpx2-device|X2 Mini Pro InputPlumber 设备描述|a0b76a1|50-onexplayer_x2_mini.yaml|https://raw.githubusercontent.com/dahui/onexplayer-x2-mini-pro-cachyos/a0b76a16471174ded80913a681357f43bfb17fa4/etc/inputplumber/devices.d/50-onexplayer_x2_mini.yaml|833fdf2079011652a9cd6991eadff4655589dac1f6293ff53ab43fc35d0ff704|
oxpx2-map|X2 Mini Pro InputPlumber 按键映射|a0b76a1|onexplayer_x2mini.yaml|https://raw.githubusercontent.com/dahui/onexplayer-x2-mini-pro-cachyos/a0b76a16471174ded80913a681357f43bfb17fa4/etc/inputplumber/capability_maps.d/onexplayer_x2mini.yaml|333d2dddd354fcb2ec2207745340c5d098dc8d173e76d8de02bf0648049f5079|
oxpx2-manager|X2 Mini Pro SteamOS 设备目标|a0b76a1|onexplayer-x2-mini.toml|https://raw.githubusercontent.com/dahui/onexplayer-x2-mini-pro-cachyos/a0b76a16471174ded80913a681357f43bfb17fa4/usr/share/steamos-manager/devices/onexplayer-x2-mini.toml|67f1136c12c103855a34c498fc3438693da7a9043d045e7147323377ed4e831a|
rustdesk|RustDesk AppImage|1.4.9|rustdesk-1.4.9-x86_64.AppImage|https://github.com/rustdesk/rustdesk/releases/download/1.4.9/rustdesk-1.4.9-x86_64.AppImage|7902cd60a4f29817eebe2668a15c9a1952ac690e8f7b07bfe7620fedd4e28217|
...
lsfg-mako|MAKO 官方中文原包|plugin-v2.2.0|MAKO-Decky-v2.2.0.zip|https://github.com/eugeniosegala/MAKO/releases/download/plugin-v2.2.0/MAKO-Decky-v2.2.0.zip|621ad66bd40f12b416e8112bb78e1aae55a96bf7fe14439b95fca1cf89324089|
...
fsr4-zh-signed|Decky-Framegen 署名中文插件|v0.17|Decky-Framegen-zh-signed-v0.17-r3.zip|https://github.com/zliu9732-hub/decky-framegen-zh/releases/download/v0.17/Decky-Framegen-zh-signed-v0.17-r3.zip|409aa32b843500a6828b73feeed5cc7307d9c7c60a470e288f2c8cf777d03adb|
...
deckymusic|Decky Music 完整包|v1.0.2|Decky.Music.full.zip|https://github.com/jinzhongjia/decky-music/releases/download/v1.0.2/Decky.Music.full.zip|37b79e28e54691f9c7e301aaa83823e20f6cffc8948d312b7398dcc87e466e11|
...
powercontrol|PowerControl|v3.15.1|PowerControl.zip|https://github.com/mengmeet/PowerControl/releases/download/v3.15.1/PowerControl.zip|9c14eddbec7657a23e73eaf811bd8344198159d48303481cf70ebb7c1c1ebd7c|
...
simpledeckytdp|SimpleDeckyTDP|v1.0.7|SimpleDeckyTDP.zip|https://github.com/aarron-lee/SimpleDeckyTDP/releases/download/v1.0.7/SimpleDeckyTDP.zip|dae7cf43ec8936c07a94a08ac418be8d9e129744a54f3aa63d2b31222bc0ad38|
...
ge-proton|GE-Proton|GE-Proton11-5|GE-Proton11-5-x86_64.tar.gz|https://github.com/GloriousEggroll/proton-ge-custom/releases/download/GE-Proton11-5/GE-Proton11-5-x86_64.tar.gz|de43c4b25f3c047db49b96c44d84759952c5a01332a68805a09e69f95dc38a75|
