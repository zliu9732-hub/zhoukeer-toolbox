...
while IFS= read -r -d '' source_path; do
    case "$source_path" in
        dist/*|mirrors/*|decky-plugins/zhoukeer-localizer/*|modules/clover_boot.sh|assets/background.png|assets/welcome.png|assets/disclaimer-usage.png|assets/windows-switch.png|assets/clover/*|website/*|index.html|todesk.html) continue ;;
