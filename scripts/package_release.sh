...
VERIFY_FILES="VERSION main.sh launch.sh install.sh update.sh bootstrap.sh modules/software.sh modules/domestic_source.sh modules/steam_accelerator.sh modules/steam302_root_start.sh modules/plugin_store.sh modules/game_launchers.sh modules/ge_proton.sh modules/todesk.sh modules/memory_tuning.sh modules/clover_boot.sh modules/dual_system.sh modules/dual_system_tools.sh scripts/steam_shortcut.py scripts/steam_compat.py scripts/install-decky-plugin.sh core/gui.sh core/platform.sh assets/icon.png assets/icon-round.png assets/windows-switch.png assets/game-launchers/epic.png assets/game-launchers/epic-grid.jpg assets/game-launchers/epic-portrait.jpg assets/game-launchers/epic-hero.jpg assets/game-launchers/battlenet.png assets/game-launchers/battlenet-grid.jpg assets/game-launchers/battlenet-portrait.jpg assets/game-launchers/battlenet-hero.jpg assets/game-launchers/ubisoft.png assets/game-launchers/ubisoft-grid.jpg assets/game-launchers/ubisoft-portrait.jpg assets/game-launchers/ubisoft-hero.jpg assets/clover/config.plist assets/clover/zhoukeer-phantom/theme.plist assets/clover/zhoukeer-phantom/background.png third_party/decky-lsfg-vk-zh-v0.12.5/dist/index.js third_party/decky-framegen-zh-v0.15.6/dist/index.js utils/github_download.sh"
PACKAGE_SOURCES=()
