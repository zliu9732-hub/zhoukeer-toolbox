...
VERIFY_FILES="VERSION main.sh install.sh modules/software.sh modules/plugin_store.sh modules/game_launchers.sh scripts/steam_shortcut.py scripts/install-decky-plugin.sh core/gui.sh assets/icon.png assets/icon-round.png third_party/decky-lsfg-vk-zh-v0.12.5/dist/index.js third_party/decky-framegen-zh-v0.15.6/dist/index.js"
PACKAGE_SOURCES=()
