...
VERIFY_FILES="VERSION LICENSE THIRD_PARTY_LICENSES.md main.sh launch.sh install.sh update.sh bootstrap.sh modules/software.sh modules/domestic_source.sh modules/new_machine.sh modules/network.sh modules/diagnostics.sh modules/preflight.sh modules/settings_backup.sh modules/steam_accelerator.sh modules/steam302_root_start.sh modules/console_accelerators.sh modules/plugin_store.sh modules/game_launchers.sh modules/emulators.sh modules/ge_proton.sh modules/proton_cachyos.sh modules/todesk.sh modules/memory_tuning.sh modules/f1_screen_fix.sh modules/f1l_button_fix.sh modules/onexplayer_button_fix.sh modules/f1_bios_prepare.sh modules/dual_system.sh modules/dual_system_tools.sh modules/clover_boot.sh modules/rog_white_theme.sh modules/handheld_pink_theme.sh modules/pink_white_gradient_theme.sh scripts/steam_shortcut.py scripts/steam_compat.py scripts/install-decky-plugin.sh scripts/apply_steam_artwork.sh scripts/build_steam_artwork_payload.py scripts/decky_ws_call.py scripts/decky_probe.py scripts/open_steam_internal_browser.sh scripts/mirror_gitee_assets.sh core/gui.sh core/platform.sh core/download_policy.sh core/source_status.sh data/fsr4_optiscaler_tested_games_2026-08-07.txt data/mako_zh.json data/mako_zh_en.json assets/icon.png assets/icon-round.png assets/icon-toolbox-deck.png assets/windows-switch.png assets/background.jpg assets/software/wechat.png assets/emulators/yuzu.png assets/emulators/cemu.png assets/emulators/duckstation.png assets/emulators/pcsx2.png assets/emulators/rpcs3.png assets/emulators/shadps4.png assets/cssloader/rog-white/theme.json assets/cssloader/rog-white/shared.css assets/cssloader/handheld-pink/theme.json assets/cssloader/handheld-pink/shared.css assets/cssloader/pink-white-gradient/theme.json assets/cssloader/pink-white-gradient/shared.css assets/clover/config.plist assets/clover/zhoukeer-phantom/background.png assets/clover/zhoukeer-phantom/theme.plist assets/clover/devices/SD-config.plist assets/clover/drivers/asusrogally.efi assets/clover/bootmanager/clover-bootmanager.sh third_party/cssloader-zh-v2.1.2/dist/index.js third_party/cssloader-zh-v2.1.2/plugin.json third_party/cssloader-zh-v2.1.2/package.json third_party/cssloader-zh-v2.1.2/LICENSE third_party/decky-simpledeckytdp-zh-v1.0.7/dist/index.js third_party/decky-simpledeckytdp-zh-v1.0.7/plugin.json third_party/decky-simpledeckytdp-zh-v1.0.7/package.json third_party/allycenter-zh-v1.2.0/dist/index.js third_party/allycenter-zh-v1.2.0/plugin.json third_party/allycenter-zh-v1.2.0/package.json third_party/allycenter-zh-v1.2.0/LICENSE third_party/huesync-cn-v3.9.0/dist/index.js third_party/huesync-cn-v3.9.0/plugin.json third_party/huesync-cn-v3.9.0/package.json third_party/huesync-cn-v3.9.0/LICENSE third_party/legion-go-remapper-zh-v0.3.0/dist/index.js third_party/legion-go-remapper-zh-v0.3.0/plugin.json third_party/legion-go-remapper-zh-v0.3.0/package.json third_party/legion-go-remapper-zh-v0.3.0/LICENSE third_party/gpd-control-zh-v0.0.2/dist/index.js third_party/gpd-control-zh-v0.0.2/plugin.json third_party/gpd-control-zh-v0.0.2/package.json third_party/gpd-control-zh-v0.0.2/LICENSE third_party/lego-vibe-control-zh-v1.5.0/dist/index.js third_party/lego-vibe-control-zh-v1.5.0/plugin.json third_party/lego-vibe-control-zh-v1.5.0/package.json third_party/lego-vibe-control-zh-v1.5.0/LICENSE third_party/lego2-fan-control-zh-v0.260430/dist/index.js third_party/lego2-fan-control-zh-v0.260430/plugin.json third_party/lego2-fan-control-zh-v0.260430/package.json third_party/lego2-fan-control-zh-v0.260430/LICENSE utils/github_download.sh utils/gitee_download.sh"
VERIFY_FILES="$VERIFY_FILES scripts/set_user_password_pty.py third_party/allycenter-zh-v1.2.0/main.py third_party/allycenter-zh-v1.2.0/README.md third_party/lego2-brightness-fix-zh-v2.0.0/dist/index.js third_party/lego2-brightness-fix-zh-v2.0.0/plugin.json third_party/lego2-brightness-fix-zh-v2.0.0/package.json third_party/lego2-brightness-fix-zh-v2.0.0/main.py third_party/lego2-brightness-fix-zh-v2.0.0/lego_updater.py third_party/lego2-brightness-fix-zh-v2.0.0/LICENSE third_party/lego2-brightness-fix-zh-v2.0.0/gamescope/lenovo.legiongo2.oled.gamma22.lua third_party/lego2-brightness-fix-zh-v2.0.0/gamescope/lenovo.legiongo2.oled.pq.lua"
VERIFY_FILES="$VERIFY_FILES core/desktop_paths.sh modules/help.sh help.html scripts/build_help_terminal_images.py assets/help/renamamiya-qr.png assets/help/xianyu-renamamiya.jpg assets/help/renamamiya-qr-compact.sixel assets/help/renamamiya-qr.sixel assets/help/renamamiya-qr-deck.sixel assets/help/renamamiya-qr-large.sixel assets/help/renamamiya-qr-wide.sixel assets/help/renamamiya-qr-full.sixel assets/help/renamamiya-qr-2k.sixel assets/help/renamamiya-qr-4k.sixel assets/help/xianyu-renamamiya-compact.sixel assets/help/xianyu-renamamiya-compact-safe.sixel assets/help/xianyu-renamamiya-safe.sixel assets/help/xianyu-renamamiya.sixel assets/help/xianyu-renamamiya-deck.sixel assets/help/xianyu-renamamiya-deck-safe.sixel assets/help/xianyu-renamamiya-large.sixel assets/help/xianyu-renamamiya-large-safe.sixel assets/help/xianyu-renamamiya-wide.sixel assets/help/xianyu-renamamiya-wide-safe.sixel assets/help/xianyu-renamamiya-full.sixel assets/help/xianyu-renamamiya-full-safe.sixel assets/help/xianyu-renamamiya-2k.sixel assets/help/xianyu-renamamiya-2k-safe.sixel assets/help/xianyu-renamamiya-4k.sixel assets/help/xianyu-renamamiya-4k-safe.sixel assets/help/renamamiya-qr.ansi assets/help/xianyu-renamamiya.ansi"
VERIFY_FILES="$VERIFY_FILES core/ui.sh modules/inputplumber_update.sh"
VERIFY_FILES="$VERIFY_FILES third_party/onexplayer-apex-tools-zh-v0.1.0/dist/index.js third_party/onexplayer-apex-tools-zh-v0.1.0/plugin.json third_party/onexplayer-apex-tools-zh-v0.1.0/package.json third_party/onexplayer-apex-tools-zh-v0.1.0/LICENSE"
PACKAGE_SOURCES=()
...
while IFS= read -r -d '' source_path; do
    case "$source_path" in
        ...
        third_party/steamdb-button-zh-v0.0.1/*|third_party/decky-translator-zh-v0.8.0/*|third_party/decky-translator-zh-v0.9.1/*) continue ;;
        third_party/cssloader-zh-v2.1.2/*)
            case "$source_path" in
                third_party/cssloader-zh-v2.1.2/plugin.json|\
                third_party/cssloader-zh-v2.1.2/package.json|\
                third_party/cssloader-zh-v2.1.2/LICENSE|\
                third_party/cssloader-zh-v2.1.2/dist/index.js) ;;
                *) continue ;;
            esac
            ;;
    esac
