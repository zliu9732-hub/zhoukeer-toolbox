...
VERIFY_FILES="VERSION LICENSE THIRD_PARTY_LICENSES.md main.sh launch.sh install.sh update.sh bootstrap.sh modules/software.sh modules/domestic_source.sh modules/new_machine.sh modules/network.sh modules/diagnostics.sh modules/preflight.sh modules/settings_backup.sh modules/steam_accelerator.sh modules/steam302_root_start.sh modules/plugin_store.sh modules/game_launchers.sh modules/emulators.sh modules/ge_proton.sh modules/todesk.sh modules/memory_tuning.sh modules/dual_system.sh modules/dual_system_tools.sh scripts/steam_shortcut.py scripts/steam_compat.py scripts/install-decky-plugin.sh scripts/apply_steam_artwork.sh scripts/build_steam_artwork_payload.py scripts/decky_ws_call.py scripts/decky_probe.py scripts/open_steam_internal_browser.sh scripts/mirror_gitee_assets.sh core/gui.sh core/platform.sh core/download_policy.sh core/source_status.sh assets/icon.png assets/icon-round.png assets/icon-toolbox-deck.png assets/background.jpg assets/emulators/yuzu.png assets/emulators/cemu.png assets/emulators/duckstation.png assets/emulators/pcsx2.png assets/emulators/rpcs3.png assets/emulators/shadps4.png third_party/decky-lsfg-vk-zh-v0.12.5/dist/index.js third_party/decky-framegen-zh-v0.17/dist/index.js utils/github_download.sh utils/gitee_download.sh"
PACKAGE_SOURCES=()
...
while IFS= read -r -d '' source_path; do
    case "$source_path" in
        dist/*|mirrors/*|decky-installer-cn/*|decky-plugins/zhoukeer-localizer/*|modules/clover_boot.sh|assets/background.png|assets/welcome.png|assets/disclaimer-usage.png|assets/windows-switch.png|assets/clover/*|assets/game-launchers/*|website/*|index.html|todesk.html) continue ;;
