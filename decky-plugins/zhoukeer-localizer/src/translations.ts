export const AUTHOR_NOTICE = "RenAmamiya汉化制作，请支持插件原作者与汉化者";
...
export const TRANSLATIONS: TranslationEntry[] = [
  ...
  {
    plugin: "OneXPlayer Apex Tools",
    aliases: ["OXP Apex Tools"],
    chineseName: "OneXPlayer Apex 工具（功耗与硬件控制）",
    strings: {
      "Use at your own risk.": "使用风险自负。",
      "Fixes": "修复功能",
      "Loading status...": "正在读取状态…",
      "EC Sensor Driver (oxpec)": "EC 传感器驱动（oxpec）",
      "Button and RGB Fix": "按键与 RGB 修复",
      "Resume Recovery": "唤醒后手柄恢复",
      "Recover Gamepad": "恢复手柄",
      "Sleep Fix (Fan Noise)": "休眠风扇修复",
      "Light Sleep": "轻度休眠",
      "Speaker DSP": "扬声器 DSP",
      "Speaker Enhancement": "扬声器增强",
      "EQ Profile": "均衡器配置",
      "Balanced": "均衡",
      "Bass Boost": "低音增强",
      "Treble": "高音增强",
      ...
      "Upper Mids": "高中音",
      "Air": "空气感",
      "Enable Speaker DSP": "启用扬声器 DSP",
      "Disable Speaker DSP": "停用扬声器 DSP",
      "Settings": "设置",
      "Enabled": "已启用",
      "Disabled": "已停用",
      "Failed": "操作失败",
