...
![按 Steam 键并打开设置](website/assets/password-reset/01-open-settings.jpg)

3. 在设置左侧选择“系统”。

![进入系统设置](website/assets/password-reset/02-system-settings.jpg)

4. 将右侧页面滑到最底部，点击“恢复出厂设置”。
5. 按屏幕提示确认，等待设备完成重置并重新进入初始设置。

![在系统页面底部选择恢复出厂设置](website/assets/password-reset/03-factory-reset.jpg)
