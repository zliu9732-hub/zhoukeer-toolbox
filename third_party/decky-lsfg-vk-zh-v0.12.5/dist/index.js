...
const manifest = {"name":"小黄鸭","author":"Kurt Himebauch (xXJSONDeruloXx)","flags":[],"api_version":1,"publish":{"tags":["installer","vulkan","lsfg","framegen","lossless","scaling"],"description":"在 Steam Deck 上通过 lsfg-vk 兼容层启用无损缩放帧生成。中文汉化：Ren-Amamiya-pixle / zliu9732-hub（闲鱼RenAmamiya）。","image":"https://raw.githubusercontent.com/xXJSONDeruloXx/decky-lsfg-vk/refs/heads/main/assets/Decky_LSFG-VK_Master_1.png"}};
const API_VERSION = 2;
...
function Content() {
    ...
    return (window.SP_REACT.createElement(DFL.PanelSection, null,
        window.SP_REACT.createElement(DFL.PanelSectionRow, null,
            window.SP_REACT.createElement("div", { style: { fontSize: "12px", opacity: 0.7, lineHeight: "1.45" } }, "\u4E2D\u6587\u6C49\u5316\uFF1ARen-Amamiya-pixle / zliu9732-hub（闲鱼RenAmamiya） \u00B7 \u539F\u63D2\u4EF6\u4F5C\u8005\uFF1AKurt Himebauch\uFF08xXJSONDeruloXx\uFF09")),
        window.SP_REACT.createElement(DFL.PanelSectionRow, null,
