(function (deckyFrontendLib, React, reactDom) {
    ...
    var RemappableButtons;
    (function (RemappableButtons) {
        RemappableButtons["Y1"] = "Y1";
        RemappableButtons["Y2"] = "Y2";
        RemappableButtons["Y3"] = "Y3";
        RemappableButtons["M2"] = "M2";
        RemappableButtons["M3"] = "M3";
    })(RemappableButtons || (RemappableButtons = {}));
    var RemapActions;
    (function (RemapActions) {
        RemapActions["DISABLED"] = "DISABLED";
        RemapActions["L_STICK_CLICK"] = "L_STICK_CLICK";
        RemapActions["L_STICK_UP"] = "L_STICK_UP";
        RemapActions["L_STICK_DOWN"] = "L_STICK_DOWN";
        RemapActions["L_STICK_LEFT"] = "L_STICK_LEFT";
        RemapActions["L_STICK_RIGHT"] = "L_STICK_RIGHT";
        RemapActions["R_STICK_CLICK"] = "R_STICK_CLICK";
        RemapActions["R_STICK_UP"] = "R_STICK_UP";
        RemapActions["R_STICK_DOWN"] = "R_STICK_DOWN";
        RemapActions["R_STICK_LEFT"] = "R_STICK_LEFT";
        RemapActions["R_STICK_RIGHT"] = "R_STICK_RIGHT";
        RemapActions["D_PAD_UP"] = "D_PAD_UP";
        RemapActions["D_PAD_DOWN"] = "D_PAD_DOWN";
        RemapActions["D_PAD_LEFT"] = "D_PAD_LEFT";
        RemapActions["D_PAD_RIGHT"] = "D_PAD_RIGHT";
        RemapActions["BUTTON_A"] = "BUTTON_A";
        RemapActions["BUTTON_B"] = "BUTTON_B";
        RemapActions["BUTTON_X"] = "BUTTON_X";
        RemapActions["BUTTON_Y"] = "BUTTON_Y";
        RemapActions["L_BUMPER"] = "L_BUMPER";
        RemapActions["L_TRIGGER"] = "L_TRIGGER";
        RemapActions["R_BUMPER"] = "R_BUMPER";
        RemapActions["R_TRIGGER"] = "R_TRIGGER";
        RemapActions["VIEW"] = "VIEW";
        RemapActions["MENU"] = "MENU";
    })(RemapActions || (RemapActions = {}));
    var RgbModes;
    (function (RgbModes) {
        RgbModes["SOLID"] = "SOLID";
        RgbModes["DYNAMIC"] = "DYNAMIC";
        RgbModes["PULSE"] = "PULSE";
        RgbModes["SPIRAL"] = "SPIRAL";
    })(RgbModes || (RgbModes = {}));
    var Gyro;
    (function (Gyro) {
        Gyro["LEFT_GYRO"] = "LEFT_GYRO";
        Gyro["RIGHT_GYRO"] = "RIGHT_GYRO";
    })(Gyro || (Gyro = {}));
    var GyroRemapActions;
    (function (GyroRemapActions) {
        GyroRemapActions["DISABLED"] = "DISABLED";
        GyroRemapActions["LEFT_JOYSTICK"] = "LEFT_JOYSTICK";
        GyroRemapActions["RIGHT_JOYSTICK"] = "RIGHT_JOYSTICK";
    })(GyroRemapActions || (GyroRemapActions = {}));
     ...
     */
    var e$2=React__default["default"];function h$4(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var k$3="function"===typeof Object.is?Object.is:h$4,l$3=e$2.useState,m$3=e$2.useEffect,n$4=e$2.useLayoutEffect,p$4=e$2.useDebugValue;function q$4(a,b){var d=b(),f=l$3({inst:{value:d,getSnapshot:b}}),c=f[0].inst,g=f[1];n$4(function(){c.value=d;c.getSnapshot=b;r$3(c)&&g({inst:c});},[a,d,b]);m$3(function(){r$3(c)&&g({inst:c});return a(function(){r$3(c)&&g({inst:c});})},[a]);p$4(d);return d}
    function r$3(a){var b=a.getSnapshot;a=a.value;try{var d=b();return !k$3(a,d)}catch(f){return !0}}function t$4(a,b){return b()}var u$3="undefined"===typeof window||"undefined"===typeof window.document||"undefined"===typeof window.document.createElement?t$4:q$4;useSyncExternalStoreShim_production_min.useSyncExternalStore=void 0!==e$2.useSyncExternalStore?e$2.useSyncExternalStore:u$3;
     ...
     * LICENSE file in the root directory of this source tree.
     */
    var h$3=React__default["default"],n$3=shim.exports;function p$3(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var q$3="function"===typeof Object.is?Object.is:p$3,r$2=n$3.useSyncExternalStore,t$3=h$3.useRef,u$2=h$3.useEffect,v$3=h$3.useMemo,w$2=h$3.useDebugValue;
    ...
    function v$1(a){if("object"===typeof a&&null!==a){var r=a.$$typeof;switch(r){case b$1:switch(a=a.type,a){case d$1:case f$1:case e:case m$1:case n$1:return a;default:switch(a=a&&a.$$typeof,a){case k$1:case h$1:case l$1:case q$1:case p$1:case g$1:return a;default:return r}}case c$1:return r}}}reactIs_production_min.ContextConsumer=h$1;reactIs_production_min.ContextProvider=g$1;reactIs_production_min.Element=b$1;reactIs_production_min.ForwardRef=l$1;reactIs_production_min.Fragment=d$1;reactIs_production_min.Lazy=q$1;reactIs_production_min.Memo=p$1;reactIs_production_min.Portal=c$1;reactIs_production_min.Profiler=f$1;reactIs_production_min.StrictMode=e;reactIs_production_min.Suspense=m$1;
    reactIs_production_min.SuspenseList=n$1;reactIs_production_min.isAsyncMode=function(){return !1};reactIs_production_min.isConcurrentMode=function(){return !1};reactIs_production_min.isContextConsumer=function(a){return v$1(a)===h$1};reactIs_production_min.isContextProvider=function(a){return v$1(a)===g$1};reactIs_production_min.isElement=function(a){return "object"===typeof a&&null!==a&&a.$$typeof===b$1};reactIs_production_min.isForwardRef=function(a){return v$1(a)===l$1};reactIs_production_min.isFragment=function(a){return v$1(a)===d$1};reactIs_production_min.isLazy=function(a){return v$1(a)===q$1};reactIs_production_min.isMemo=function(a){return v$1(a)===p$1};
    reactIs_production_min.isPortal=function(a){return v$1(a)===c$1};reactIs_production_min.isProfiler=function(a){return v$1(a)===f$1};reactIs_production_min.isStrictMode=function(a){return v$1(a)===e};reactIs_production_min.isSuspense=function(a){return v$1(a)===m$1};reactIs_production_min.isSuspenseList=function(a){return v$1(a)===n$1};
    reactIs_production_min.isValidElementType=function(a){return "string"===typeof a||"function"===typeof a||a===d$1||a===f$1||a===e||a===m$1||a===n$1||a===t$1||"object"===typeof a&&null!==a&&(a.$$typeof===q$1||a.$$typeof===p$1||a.$$typeof===g$1||a.$$typeof===h$1||a.$$typeof===l$1||a.$$typeof===u$1||void 0!==a.getModuleId)?!0:!1};reactIs_production_min.typeOf=v$1;
    ...
    function getDefaultMiddleware(options) {
        ...
        var _c = options.thunk, thunk = _c === void 0 ? true : _c; options.immutableCheck; options.serializableCheck; options.actionCreatorCheck;
    ...
    const setCurrentGameId = createAction('setCurrentGameId');

    var ServerAPIMethods;
    (function (ServerAPIMethods) {
        ServerAPIMethods["RGB_ON"] = "rgb_on";
        ServerAPIMethods["RGB_OFF"] = "rgb_off";
        ServerAPIMethods["REMAP_BUTTON"] = "remap_button";
        ServerAPIMethods["LOG_INFO"] = "log_info";
        ServerAPIMethods["GET_SETTINGS"] = "get_settings";
        ServerAPIMethods["SET_POWER_LED"] = "set_power_led";
        ServerAPIMethods["SET_CHARGE_LIMIT"] = "set_charge_limit";
        ServerAPIMethods["SET_ALS_ENABLED"] = "set_als_enabled";
        ServerAPIMethods["SAVE_SETTINGS"] = "save_settings";
    })(ServerAPIMethods || (ServerAPIMethods = {}));
    const readAls = (serverApi) => async () => {
        const { result } = await serverApi.callPluginMethod('read_als', {});
        return Number(result);
    };
    const createRgbOn = (serverAPI) => async (controller) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.RGB_ON, {
            controller
        });
    };
    const createRgbOff = (serverAPI) => async (controller) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.RGB_OFF, {
            controller
        });
    };
    const createRemapButtons = (serverAPI) => async (button, action) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.REMAP_BUTTON, {
            button,
            action
        });
    };
    const createLogInfo = (serverAPI) => async (info) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.LOG_INFO, {
            info: JSON.stringify(info)
        });
    };
    const createSetPowerLed = (serverAPI) => async (enabled) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.SET_POWER_LED, {
            enabled
        });
    };
    const createSetChargeLimit = (serverAPI) => async (enabled) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.SET_CHARGE_LIMIT, {
            enabled
        });
    };
    const createSetAlsEnabled = (serverAPI) => async (enabled) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.SET_ALS_ENABLED, {
            enabled
        });
    };
    const createSaveSettings = (serverAPI) => async (new_settings) => {
        await serverAPI.callPluginMethod(ServerAPIMethods.SAVE_SETTINGS, {
            new_settings
        });
    };
    const createGetSettings = (serverAPI) => async () => {
        return await serverAPI.callPluginMethod(ServerAPIMethods.GET_SETTINGS, {});
    };
    const createIsLegionGo2 = (serverAPI) => async () => {
        const { result } = await serverAPI.callPluginMethod('is_legion_go_2', {});
        return Boolean(result);
    };
    const createSetGamescopeBrightnessPct = (serverAPI) => async (pct) => {
        await serverAPI.callPluginMethod('set_gamescope_brightness_pct', { pct });
    };
    let serverApi;
    const saveServerApi = (s) => {
        serverApi = s;
    };
    const getServerApi = () => {
        return serverApi;
    };
    const extractDisplayName = () => `${deckyFrontendLib.Router.MainRunningApp?.display_name || 'default'}`;
    const extractCurrentGameId = () => `${deckyFrontendLib.Router.MainRunningApp?.appid || 'default'}`;
    const createServerApiHelpers = (serverAPI) => {
        return {
    ...
    const getLatestVersionNum = async (serverApi) => {
        const { result } = await serverApi.fetchNoCors('https://raw.githubusercontent.com/aarron-lee/LegionGoRemapper/main/package.json', { method: 'GET' });
        //@ts-ignore
    ...
    const otaUpdate = async (serverApi) => {
    ...
    const controllerSlice = createSlice({
        ...
        reducers: {
            setPerGameProfilesEnabled: (state, action) => {
            ...
            setControllerRemappingEnabled: (state, action) => {
                const enabled = action.payload;
                state.controllerRemappingEnabled = enabled;
            },
            remapButton: (state, action) => {
            ...
            updateControllerProfiles: (state, action) => {
                lodash.exports.merge(state.controllerProfiles, action.payload);
            },
            setTouchpad: (state, action) => {
        ...
        extraReducers: (builder) => {
            builder.addCase(setInitialState, (state, action) => {
                const controllerProfiles = action.payload
                    .controller;
                const perGameProfilesEnabled = Boolean(action.payload.controllerPerGameProfilesEnabled);
                const controllerRemappingEnabled = Boolean(action.payload.controllerRemappingEnabled);
    ...
    // selectors
    // -------------
    const selectControllerPerGameProfilesEnabled = (state) => {
        return state.controller.perGameProfilesEnabled;
    };
    const selectControllerRemappingEnabled = (state) => {
        return state.controller.controllerRemappingEnabled;
    };
    const selectTouchpadEnabled = (state) => {
        if (state.controller.perGameProfilesEnabled) {
            return lodash.exports.get(state, `controller.controllerProfiles.${extractCurrentGameId()}.TOUCHPAD`);
        }
        else {
            return lodash.exports.get(state, `controller.controllerProfiles.default.TOUCHPAD`);
        }
    };
    const selectButtonRemapAction = (button) => (state) => {
        if (state.controller.perGameProfilesEnabled) {
            return lodash.exports.get(state, `controller.controllerProfiles.${extractCurrentGameId()}.${button}`);
        }
        else {
            return lodash.exports.get(state, `controller.controllerProfiles.default.${button}`);
        }
    };
    const selectGyroRemapAction = (gyro) => (state) => {
        if (state.controller.perGameProfilesEnabled) {
            return lodash.exports.get(state, `controller.controllerProfiles.${extractCurrentGameId()}.${gyro}`);
        }
        else {
            return lodash.exports.get(state, `controller.controllerProfiles.default.${gyro}`);
        }
    };
    const selectControllerProfileDisplayName = (state) => {
        if (state.controller.perGameProfilesEnabled) {
            return deckyFrontendLib.Router.MainRunningApp?.display_name || 'Default';
        }
        else {
            return 'Default';
        }
    ...
    const saveControllerSettingsMiddleware = (store) => (next) => (action) => {
        const { type } = action;
        const serverApi = getServerApi();
        const result = next(action);
        if (mutatingActionTypes$2.includes(type)) {
            // save changes to backend
            const { controller: { controllerProfiles, perGameProfilesEnabled, controllerRemappingEnabled }, ui: { currentGameId: currentId } } = store.getState();
            let currentGameId;
    ...
    // -------------
    function setStateValue$2({ sliceState, key, value }) {
        if (sliceState.perGameProfilesEnabled) {
            const currentGameId = extractCurrentGameId();
            lodash.exports.set(sliceState, `controllerProfiles.${currentGameId}.${key}`, value);
        }
        else {
            lodash.exports.set(sliceState, `controllerProfiles.default.${key}`, value);
        }
    }
    function bootstrapControllerProfile(state, newGameId) {
    ...
    const useTouchpadEnabled = () => {
        const touchpadEnabled = useSelector(selectTouchpadEnabled);
        const dispatch = useDispatch();
        const setTouchpad = (enabled) => {
            return dispatch(controllerSlice.actions.setTouchpad(enabled));
        };
        return { touchpadEnabled, setTouchpad };
    };
    const useControllerRemappingEnabled = () => {
        const controllerRemappingEnabled = useSelector(selectControllerRemappingEnabled);
        const dispatch = useDispatch();
        const setControllerRemappingEnabled = (enabled) => {
    ...
    const useControllerPerGameEnabled = () => {
        const controllerPerGameEnabled = useSelector(selectControllerPerGameProfilesEnabled);
        const dispatch = useDispatch();
        const setControllerPerGameEnabled = (enabled) => {
    ...
    const useRemapAction = (btn) => {
        const remapAction = useSelector(selectButtonRemapAction(btn));
        const dispatch = useDispatch();
        const setRemapAction = (remapAction) => {
            return dispatch(controllerSlice.actions.remapButton({ button: btn, remapAction }));
        };
        return { remapAction, setRemapAction };
    };
    const useGyroRemapAction = (gyro) => {
        const gyroRemapAction = useSelector(selectGyroRemapAction(gyro));
        const dispatch = useDispatch();
        const setGyroRemapAction = (remapAction) => {
            return dispatch(controllerSlice.actions.setGyro({ gyro, remapAction: remapAction }));
        };
        return { gyroRemapAction, setGyroRemapAction };
    };
    const useControllerProfileDisplayName = () => {
        return useSelector(selectControllerProfileDisplayName);
    };

    const RemapActionDropdown = ({ btn }) => {
        ...
        return (window.SP_REACT.createElement("div", null,
            window.SP_REACT.createElement(deckyFrontendLib.DropdownItem, { bottomSeparator: "none", rgOptions: dropdownOptions.map((o) => {
                    return {
                        data: o.data,
                        label: o.label,
                        value: o.value
                ...
                })?.data || RemapActions.DISABLED, onChange: (value) => {
                    setRemapAction(value.data);
                } })));
    };

    const M1 = ({ fill = 'currentColor' }) => (window.SP_REACT.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "-10 0 1020 1000" },
        window.SP_REACT.createElement("path", { fill: fill, d: "M929 310q30 0 50.5 21t20.5 50v238q0 29 -20.5 50t-50.5 21h-850q-29 0 -50 -21t-21 -50v-238q0 -29 21 -50t50 -21h850zM550 614v-227h-84l-71 158l-70 -158h-84v227h68v-120l54 120h65l53 -120v120h69zM768 614v-227h-130v41h62v186h68z" })));

    const M2 = ({ fill = 'currentColor' }) => (window.SP_REACT.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "-10 0 1016 1000" },
        window.SP_REACT.createElement("path", { fill: fill, d: "M925 310q29 0 50 21t21 50v238q0 29 -21 50t-50 21h-850q-29 0 -50 -21t-21 -50v-238q0 -29 21 -50t50 -21h850zM515 613v-226h-84l-70 158l-71 -158h-84v226h69v-119l53 119h65l54 -119v119h68zM794 469v-36q0 -46 -58 -46h-138v41h115q12 0 12 9v28q0 9 -12 9h-74\nq-58 0 -58 47v92h213v-41h-144v-47q0 -10 12 -10h74q58 0 58 -46z" })));

    const M3 = ({ fill = 'currentColor' }) => (window.SP_REACT.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "-10 0 1016 1000" },
        window.SP_REACT.createElement("path", { fill: fill, d: "M925 310q29 0 50 21t21 50v238q0 29 -21 50t-50 21h-850q-29 0 -50 -21t-21 -50v-238q0 -29 21 -50t50 -21h850zM206 610h68v-120l54 120h65l53 -120v120h69v-227h-84l-71 159l-70 -159h-84v227zM580 610h148q59 0 59 -47v-32q0 -30 -25 -41q25 -11 25 -41v-19\nq0 -47 -59 -47h-148v41h126q12 0 12 10v27q0 10 -12 10h-95v41h95q12 0 12 10v37q0 10 -12 10h-126v41z" })));

    const Y1 = ({ fill = 'currentColor' }) => (window.SP_REACT.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "-10 0 1016 1000" },
        window.SP_REACT.createElement("path", { fill: fill, d: "M925 310q29 0 50 21t21 50v238q0 29 -21 50t-50 21h-850q-29 0 -50 -21t-21 -50v-238q0 -29 21 -50t50 -21h850zM264 387l104 142v85h68v-85l104 -142h-75l-63 87l-63 -87h-75zM605 428h62v185h69v-226h-131v41z" })));

    const Y2 = ({ fill = 'currentColor' }) => (window.SP_REACT.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "-10 0 1016 1000" },
        window.SP_REACT.createElement("path", { fill: fill, d: "M925 310q29 0 50 21t21 50v238q0 29 -21 50t-50 21h-850q-29 0 -50 -21t-21 -50v-238q0 -29 21 -50t50 -21h850zM238 387l103 142v85h69v-85l103 -142h-74l-64 87l-63 -87h-74zM549 613v1h213v-42h-144v-47q0 -9 12 -9h74q58 0 58 -47v-36q0 -46 -58 -46h-138v41h115\nq12 0 12 9v28q0 9 -12 9h-74q-58 0 -58 47v92z" })));

    const Y3 = ({ fill = 'currentColor' }) => (window.SP_REACT.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", version: "1.1", viewBox: "-10 0 1016 1000" },
        window.SP_REACT.createElement("path", { fill: fill, d: "M925 310q29 0 50 21t21 50v238q0 29 -21 50t-50 21h-850q-29 0 -50 -21t-21 -50v-238q0 -29 21 -50t50 -21h850zM238 387l103 142v85h69v-85l103 -142h-74l-64 87l-63 -87h-74zM556 613v1h148q58 0 58 -47v-33q0 -30 -24 -41q24 -11 24 -41v-19q0 -46 -58 -46h-148v41\nh125q12 0 12 9v28q0 9 -12 9h-94v42h94q12 0 12 9v38q0 9 -12 9h-125v41z" })));
    ...
    const IconRow = ({ btn, children }) => {
        const Component = IconMap[btn];
        return (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, { bottomSeparator: "none" },
            window.SP_REACT.createElement("div", { style: {
                ...
                window.SP_REACT.createElement("span", { style: {
                        ...
                        fontSize: '1.5em',
                        boxSizing: 'border-box'
                    } }, Component && window.SP_REACT.createElement(Component, null)),
                window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: { display: 'flex', margin: '0', padding: '0' } },
                    window.SP_REACT.createElement("div", { style: {
                            display: 'flex',
                            fontSize: '1.5em',
    ...
    var GyroModes;
    (function (GyroModes) {
        GyroModes[GyroModes["DISABLED"] = 0] = "DISABLED";
        GyroModes[GyroModes["LEFT_JOYSTICK"] = 1] = "LEFT_JOYSTICK";
        GyroModes[GyroModes["RIGHT_JOYSTICK"] = 2] = "RIGHT_JOYSTICK";
    })(GyroModes || (GyroModes = {}));
    const MODES = [
        {
    ...
    const GyroRemapActionDropdown = ({ gyro }) => {
        ...
        const handleChange = (value) => {
            ...
            const newMode = GyroModes[value];
            return setGyroRemapAction(newMode);
        };
        return (window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: gyro.split('_').join(' '), value: GyroModes[gyroRemapAction], min: 0, max: 2, step: 1, notchCount: 3, notchLabels: MODES, notchTicksVisible: true, showValue: false, bottomSeparator: "none", onChange: handleChange }));
    };
    ...
    const RemapButtons = () => {
        ...
        const { controllerPerGameEnabled, setControllerPerGameEnabled } = useControllerPerGameEnabled();
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: title },
                window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                    window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: '启用手柄按键映射', checked: controllerRemappingEnabled, onChange: setControllerRemappingEnabled })),
                controllerRemappingEnabled && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.Field, { disabled: true }, "\u26A0\uFE0F WARNING \u26A0\uFE0F - Don't use these remapping features with Controller Emulators. If you are using Handheld Daemon (hhd), use the Dualsense Edge controller + remap back buttons with Steam Input")),
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: '启用按游戏映射', checked: controllerPerGameEnabled, onChange: setControllerPerGameEnabled })),
                    window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "\u89E6\u63A7\u677F", checked: touchpadEnabled, onChange: (value) => setTouchpad(value) }),
                    btns.map((btn, idx) => {
                        return (window.SP_REACT.createElement(IconRow, { btn: btn, key: idx },
                            window.SP_REACT.createElement(RemapActionDropdown, { btn: btn })));
                    }),
                    gyros.map((gyro, idx) => {
                        return window.SP_REACT.createElement(GyroRemapActionDropdown, { gyro: gyro, key: idx });
                    }))))));
    };
    ...
    const bootstrapRgbProfile = (state, newGameId) => {
        ...
        (!state.rgbProfiles[newGameId] && state.perGameProfilesEnabled) ||
            // always initialize default
            newGameId === 'default') {
            const defaultProfile = lodash.exports.get(state, 'rgbProfiles.default', {});
            const newRgbProfile = {
    ...
    const rgbSlice = createSlice({
        ...
        reducers: {
            setEnableRgbControl: (state, action) => {
                const enabled = action.payload;
            ...
            updateRgbProfiles: (state, action) => {
                lodash.exports.merge(state.rgbProfiles, action.payload);
            },
            ...
            setPowerLedEnabled: (state, action) => {
                const enabled = action.payload;
        ...
        extraReducers: (builder) => {
            builder.addCase(setInitialState, (state, action) => {
                const rgbProfiles = action.payload.rgb;
                const perGameProfilesEnabled = Boolean(action.payload.rgbPerGameProfilesEnabled);
                ...
                state.perGameProfilesEnabled = perGameProfilesEnabled;
                state.forceEnableSeparateLedManagement = Boolean(action.payload.forceEnableSeparateLedManagement);
            });
            builder.addCase(setCurrentGameId, (state, action) => {
                /*
                  currentGameIdChanged, check if exists in redux store.
    ...
    // selectors
    // -------------
    const selectRgbInfo = (controller) => (state) => {
        const currentGameId = extractCurrentGameId();
        let rgbInfo;
    ...
    const selectRgbMode = (controller) => (state) => {
        const currentGameId = extractCurrentGameId();
        let rgbMode;
        if (state.rgb.perGameProfilesEnabled) {
    ...
    const selectPerGameProfilesEnabled = (state) => {
        return state.rgb.perGameProfilesEnabled;
    };
    const selectRgbProfileDisplayName = (state) => {
        if (state.rgb.perGameProfilesEnabled) {
            return deckyFrontendLib.Router.MainRunningApp?.display_name || 'Default';
        }
        else {
    ...
    const selectEnableRgbControl = (state) => {
        return Boolean(state.rgb.enableRgbControl);
    };
    const selectPowerLedEnabled = (state) => {
        return Boolean(state.rgb.powerLedEnabled);
    };
    // -------------
    // middleware
    // -------------
    const mutatingActionTypes$1 = [
    ...
    const saveRgbSettings = (store) => {
        const serverApi = getServerApi();
        const { rgb: { rgbProfiles, perGameProfilesEnabled, enableRgbControl } } = store.getState();
    ...
    const debouncedSaveRgbSettings = lodash.exports.debounce(saveRgbSettings, 300);
    const saveRgbSettingsMiddleware = (store) => (next) => (action) => {
        const { type } = action;
        const serverApi = getServerApi();
        const result = next(action);
        ...
        if (mutatingActionTypes$1.includes(type)) {
            // save to backend
        ...
        if (type === setInitialState.type || type === setCurrentGameId.type) {
            ...
            const { rgb: { perGameProfilesEnabled } } = store.getState();
            const currentGameId = perGameProfilesEnabled
                ? extractCurrentGameId()
                : 'default';
    ...
    // Slice Util functions
    // -------------
    function setStateValue$1({ sliceState, controller, key, value }) {
        if (sliceState.perGameProfilesEnabled) {
            const currentGameId = extractCurrentGameId();
    ...
    const useSeparateRgbManagementEnabled = () => {
        return false;
    };
    const useEnableRgbControl = () => {
    ...
    const usePerGameRgbProfilesEnabled = () => {
    ...
    const useRgbProfileDisplayName = () => useSelector(selectRgbProfileDisplayName);
    ...
    const useRgb = (controller) => {
        ...
        const setRgbColor = (red, green, blue, hue) => {
            return dispatch(rgbSlice.actions.setRgbColor({ controller, red, green, blue, hue }));
        };
        const setEnabled = (enabled) => {
    ...
    const RgbPerGameProfilesToggle = () => {
        const [perGameProfilesEnabled, setPerGameProfilesEnabled] = usePerGameRgbProfilesEnabled();
        return (window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "\u542F\u7528\u6309\u6E38\u620F\u914D\u7F6E", checked: perGameProfilesEnabled, onChange: setPerGameProfilesEnabled }));
    };

    var Mode;
    (function (Mode) {
        Mode[Mode["SOLID"] = 0] = "SOLID";
        Mode[Mode["DYNAMIC"] = 1] = "DYNAMIC";
        Mode[Mode["PULSE"] = 2] = "PULSE";
        Mode[Mode["SPIRAL"] = 3] = "SPIRAL";
    })(Mode || (Mode = {}));
    const RgbModeSlider = ({ controller }) => {
        const [mode, setMode] = useRgbMode(controller);
        const handleSliderChange = (value) => {
            return setMode(Mode[value]);
        };
        const MODES = Object.keys(Mode).filter(key => isNaN(Number(key))).map((mode, idx) => {
            return { notchIndex: idx, label: lodash.exports.capitalize(mode), value: idx };
        });
        // known bug: typescript has incorrect type for reverse mapping from enums
        const sliderValue = Mode[mode];
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(deckyFrontendLib.SliderField, { value: sliderValue, min: 0, max: MODES.length - 1, step: 1, notchCount: MODES.length, notchLabels: MODES, notchTicksVisible: true, showValue: false, bottomSeparator: 'none', onChange: handleSliderChange })));
    };
    ...
    const RgbSettings = ({ controller }) => {
        ...
        const label = '手柄灯光';
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: label, checked: enabled, onChange: rgb.setEnabled, bottomSeparator: enabled ? 'none' : 'thick' }),
            enabled && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: 'below', bottomSeparator: showOptions ? 'none' : 'thick', style: {
                        width: '100%',
                        height: '20px',
                        display: 'flex',
                        justifyContent: 'center',
                        alignItems: 'center' // Center align vertically
                    }, onClick: () => setShowOptions(!showOptions) }, showOptions ? window.SP_REACT.createElement(IoMdArrowDropup, null) : window.SP_REACT.createElement(IoMdArrowDropdown, null)))),
            showOptions && enabled && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                window.SP_REACT.createElement(RgbModeSlider, { controller: controller }),
                window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: `亮度`, valueSuffix: "%", value: brightness, showValue: true, min: 1, max: 100, validValues: "range", bottomSeparator: 'none', onChange: (value) => rgb.updateBrightness(value) }),
                mode !== RgbModes.SOLID && (window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: "\u901F\u5EA6", valueSuffix: "%", value: speed, showValue: true, min: 1, max: 100, validValues: "range", onChange: (value) => rgb.setSpeed(value) })),
                !HIDE_COLOR_PICKER_MODES.includes(mode) && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement("div", { className: "ColorPicker_HSlider" },
                        window.SP_REACT.createElement(deckyFrontendLib.SliderField, { showValue: true, label: "\u8272\u76F8", value: hue, min: 0, max: 359, validValues: "range", bottomSeparator: "thick", onChange: (value) => rgb.setHue(value) })))),
                window.SP_REACT.createElement("style", null, `
            .ColorPicker_HSlider .${deckyFrontendLib.gamepadSliderClasses.SliderTrack} {
    ...
    const EnableRgbControlToggle = () => {
        const { rgbControlEnabled, setRgbControlEnabled } = useEnableRgbControl();
        return (window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "\u542F\u7528 RGB \u63A7\u5236", checked: rgbControlEnabled, onChange: setRgbControlEnabled }));
    };

    const ControllerLightingPanel = () => {
        ...
        let title = displayName === 'Default'
            ? '手柄灯光'
            : `手柄灯光 - ${displayName.substring(0, 10)}...`;
        return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: title },
            window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "\u542F\u7528\u7535\u6E90\u6307\u793A\u706F", checked: powerLedEnabled, onChange: setPowerLed }),
            window.SP_REACT.createElement(EnableRgbControlToggle, null),
            rgbControlEnabled && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                window.SP_REACT.createElement(RgbPerGameProfilesToggle, null),
                window.SP_REACT.createElement(RgbSettings, { controller: "RIGHT" }),
                separateRgbManagementEnabled ))));
    };
    ...
    const smoothTimeInfo = {
        range: [100, 1000],
        step: 50
    };
    const brightnessOffsetInfo = {
        range: [-30, 30],
        step: 5
    };
    const DEFAULT_POLLING_RATE = 100;
    const DEFAULT_SMOOTH_TIME = 500;
    const DEFAULT_SENSITIVITY = 50;
    const DEFAULT_BRIGHTNESS_OFFSET = 0;
    ...
    const handleAls = async () => {
        ...
        const { readAls, setGamescopeBrightnessPct } = createServerApiHelpers(serverAPI);
        while (enableAdaptiveBrightness) {
            ...
            const averageAlsValue = previousAlsValues.reduce((acc, val) => acc + val, 0) /
    ...
    const enableAlsListener = () => {
        ...
        if (!steamRegistration)
            steamRegistration =
                window.SteamClient.System.Display.RegisterForBrightnessChanges(async (data) => {
                    currentBrightness = data.flBrightness * 100;
                });
    };
    const setPollRate = (newRate) => {
        pollingRate = newRate;
    };
    const setSmoothTime = (newTime) => {
        smoothTime = newTime;
    };
    const clearAlsListener = () => {
        enableAdaptiveBrightness = false;
        previousAlsValues.fill(-1);
    };
    const setSensitivity = (arrSize) => {
        previousAlsValues = Array(arrSize).fill(-1);
    };
    const setBrightnessOffset = (offset) => {
        const delta = offset - brightnessOffset;
        brightnessOffset = offset;
        if (!enableAdaptiveBrightness || delta === 0)
            return;
        const newTarget = Math.min(100, Math.max(0, currentBrightness + delta));
        if (newTarget === currentBrightness)
            return;
        ...
        extraReducers: (builder) => {
            builder.addCase(setInitialState, (state, action) => {
                ...
                if (action.payload?.alsInfo) {
                    const { pollingRate, smoothTime, sensitivity, brightnessOffset: savedOffset } = action.payload.alsInfo || {};
    ...
    const getPluginVersionNumSelector = (state) => state.ui.pluginVersionNum;
    const getInitialLoading = (state) => state.ui.initialLoading;
    const selectCurrentGameDisplayName = (state) => state.ui?.currentDisplayName || 'default';
    const selectChargeLimitEnabled = (state) => Boolean(state.ui?.chargeLimitEnabled);
    const selectAlsEnabled = (state) => Boolean(state.ui?.alsEnabled);
    const selectAlsPollingRate = (state) => state.ui.alsInfo.pollingRate;
    const selectSmoothTime = (state) => state.ui.alsInfo.smoothTime;
    const selectSensitivity = (state) => state.ui.alsInfo.sensitivity;
    const selectBrightnessOffset = (state) => state.ui.alsInfo.brightnessOffset;
    const uiSliceMiddleware = (_store) => (next) => (action) => {
        const { type } = action;
        const serverApi = getServerApi();
        const result = next(action);
        if (serverApi) {
            const { setChargeLimit, setAlsEnabled, saveSettings } = createServerApiHelpers(serverApi);
    ...
    const fanSlice = createSlice({
        ...
        initialState,
        reducers: {
            setCustomFanCurvesEnabled: (state, action) => {
                const enabled = action.payload;
            ...
            setFanPerGameProfilesEnabled: (state, action) => {
                const enabled = action.payload;
            ...
            setEnableFullFanSpeedMode: (state, action) => {
                const enabled = action.payload;
            ...
            updateFanProfiles: (state, action) => {
                lodash.exports.merge(state.fanProfiles, action.payload);
            }
        },
        extraReducers: (builder) => {
            builder.addCase(setInitialState, (state, action) => {
                const fanProfiles = action.payload.fan;
                const customFanCurvesEnabled = Boolean(action.payload.customFanCurvesEnabled);
                const fanPerGameProfilesEnabled = Boolean(action.payload.fanPerGameProfilesEnabled);
    ...
    // selectors
    // -------------
    const selectSupportsCustomFanCurves = (state) => {
        return Boolean(state.fan.supportsCustomFanCurves);
    };
    const selectCustomFanCurvesEnabled = (state) => {
        return Boolean(state.fan.customFanCurvesEnabled);
    };
    const selectFanPerGameProfilesEnabled = (state) => {
        return Boolean(state.fan.fanPerGameProfilesEnabled);
    };
    const selectActiveFanProfile = (state) => {
    ...
    const selectActiveFanCurve = (state) => {
        const profile = selectActiveFanProfile(state);
        const p = lodash.exports.cloneDeep(profile);
        delete p.fullFanSpeedEnabled;
        const x = p;
        return x;
    };
    const selectEnableFullFanSpeedMode = (state) => {
        const profile = selectActiveFanProfile(state);
    ...
    const saveFanSettingsMiddleware = (store) => (next) => (action) => {
        const { type } = action;
        const serverApi = getServerApi();
        const result = next(action);
        const state = store.getState();
        const { fan: { fanPerGameProfilesEnabled, customFanCurvesEnabled }, ui: { currentGameId: currentId } } = state;
        let currentGameId;
    ...
    function setFanCurve(state, currentGameId) {
        const serverApi = getServerApi();
        const { fan: { fanProfiles, fanPerGameProfilesEnabled, customFanCurvesEnabled } } = state;
        const fanInfo = {
            fanProfiles,
    ...
    // Slice Util functions
    // -------------
    function setStateValue({ sliceState, key, value }) {
        if (sliceState.fanPerGameProfilesEnabled) {
            const currentGameId = extractCurrentGameId();
            lodash.exports.set(sliceState, `fanProfiles.${currentGameId}.${key}`, value);
        }
        else {
            lodash.exports.set(sliceState, `fanProfiles.default.${key}`, value);
        }
    }
    function bootstrapFanProfile(state, newGameId) {
    ...
    let intervalId;
    const currentGameIdListener = () => {
        intervalId = window.setInterval(() => {
            const { ui: { currentGameId: oldGameId } } = store.getState();
            const currentGameId = extractCurrentGameId();
    ...
    var logo = 'http://127.0.0.1:1337/plugins/Legion Go 控制中心/assets/Icon-6e8d5086.png';

    const useEnableFullFanSpeedMode = () => {
        const result = useSelector(selectEnableFullFanSpeedMode);
        const dispatch = useDispatch();
        const setter = (enabled) => {
    ...
    const useSupportsCustomFanCurves = () => {
        const result = useSelector(selectSupportsCustomFanCurves);
        return result;
    };
    const useCustomFanCurvesEnabled = () => {
    ...
    const useFanPerGameProfilesEnabled = () => {
    ...
    const useDisableLimit = () => {
        const [disableLimits, setDisableLimits] = React.useState(window.localStorage.getItem(DISABLE_KEY) === 'true' || false);
        const setLimit = (enable) => {
    ...
    const FanCurveSliders = () => {
        ...
        const sliders = Object.entries(activeFanCurve).map(([temp, fanSpeed], idx) => {
            const updateFanCurveValue = (temp, fanSpeed) => {
            ...
            return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                    window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: `${temp} \u2103`, value: fanSpeed, showValue: true, valueSuffix: "%", step: 5, min: 5, max: 115, validValues: "range", bottomSeparator: "none", key: idx, onChange: (newSpeed) => {
                            return updateFanCurveValue(temp, newSpeed);
                        } }))));
        });
        return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: '温度（\u2103）| 风扇转速（%）' },
            window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "\u7981\u7528\u98CE\u6247\u66F2\u7EBF\u9650\u5236", checked: disableLimits, onChange: setLimit })),
            sliders));
    };

    const useTitle = (fanPerGameProfilesEnabled) => {
        const currentDisplayName = useSelector(selectCurrentGameDisplayName);
        if (!fanPerGameProfilesEnabled) {
            return '风扇控制';
        }
        const title = `风扇控制 - ${lodash.exports.capitalize(currentDisplayName)}`;
        return title;
    };
    ...
    const FanPanel = () => {
        ...
        React.useState(window.localStorage.getItem(WARNING_KEY) === 'true');
        const { enableFullFanSpeedMode, setEnableFullFanSpeedMode } = useEnableFullFanSpeedMode();
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: title },
                window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                    window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: '启用自定义风扇曲线', checked: customFanCurvesEnabled, onChange: setCustomFanCurvesEnabled })),
                customFanCurvesEnabled && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: '启用按游戏风扇曲线', checked: fanPerGameProfilesEnabled, onChange: setFanPerGameProfilesEnabled })),
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", bottomSeparator: showSliders ? 'none' : 'thick', style: {
                                width: '100%',
                                height: '20px',
                                display: 'flex',
                                justifyContent: 'center',
                                alignItems: 'center' // Center align vertically
                            }, onClick: () => setShowSliders(!showSliders) }, showSliders ? window.SP_REACT.createElement(IoMdArrowDropup, null) : window.SP_REACT.createElement(IoMdArrowDropdown, null))),
                    showSliders && (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: '启用全速风扇模式', checked: enableFullFanSpeedMode, onChange: setEnableFullFanSpeedMode })))))),
            customFanCurvesEnabled && !enableFullFanSpeedMode && showSliders && (window.SP_REACT.createElement(FanCurveSliders, null))));
    };
    ...
    function AlsPanel () {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "\u73AF\u5883\u5149\u4F20\u611F\u5668" },
                window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                    window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: '启用自动亮度（实验性）', checked: enabledAls, onChange: setAlsEnabled })),
                enabledAls && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: "\u7075\u654F\u5EA6", value: sensitivity, min: minSensitivity, max: maxSensitivity, onChange: setSensitivity, step: sensitivityInfo.step, notchTicksVisible: true, showValue: true })),
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: "\u8F6E\u8BE2\u95F4\u9694\uFF08\u6BEB\u79D2\uFF09", value: pollingRate, min: minPollRate, max: maxPollRate, onChange: setPollingRate, step: pollInfo.step, notchTicksVisible: true, showValue: true })),
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: "\u5E73\u6ED1\u65F6\u95F4\uFF08\u6BEB\u79D2\uFF09", value: smoothTime, min: minSmoothTime, max: maxSmoothTime, onChange: setSmoothTime, step: smoothTimeInfo.step, notchTicksVisible: true, showValue: true })),
                    window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                        window.SP_REACT.createElement(deckyFrontendLib.SliderField, { label: "\u4EAE\u5EA6\u504F\u79FB", value: brightnessOffset, min: minOffset, max: maxOffset, onChange: setBrightnessOffset, step: brightnessOffsetInfo.step, notchTicksVisible: true, showValue: true })))))));
    }
    ...
    class ErrorBoundary extends React.Component {
        ...
        render() {
            if (this.state.hasError) {
                return (window.SP_REACT.createElement(deckyFrontendLib.Field, { disabled: true, label: "\u9519\u8BEF" },
                    "Error while trying to render ",
                    this.props.title));
            }
    ...
    const OtaUpdates = () => {
        const [latestVersionNum, setLatestVersionNum] = React.useState('');
        ...
        let buttonText = `更新到 ${latestVersionNum}`;
        if (installedVersionNum === latestVersionNum && Boolean(latestVersionNum)) {
            buttonText = '重新安装插件';
        }
        return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "\u66F4\u65B0" },
            window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                window.SP_REACT.createElement(deckyFrontendLib.Field, { disabled: true, label: '已安装版本' }, installedVersionNum)),
            Boolean(latestVersionNum) && (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                window.SP_REACT.createElement(deckyFrontendLib.Field, { disabled: true, label: '最新版本' }, latestVersionNum))),
            Boolean(latestVersionNum) && (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { onClick: () => {
                        ...
                        justifyContent: 'center',
                        alignItems: 'center'
                    }, layout: 'below' }, buttonText)))));
    };

    const useChargeLimitEnabled = () => {
        const chargeLimitEnabled = useSelector(selectChargeLimitEnabled);
        const dispatch = useDispatch();
        const setChargeLimit = (enabled) => {
    ...
    const Content = React.memo(() => {
        ...
        return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
            window.SP_REACT.createElement("div", { style: { color: "#d9a441", fontSize: "12px", padding: "4px 12px" } }, "\u4E2D\u6587\u6C49\u5316\uFF1ARen-Amamiya-pixle / zliu9732-hub（闲鱼RenAmamiya）"),
            ...
            window.SP_REACT.createElement(ErrorBoundary, { title: "\u81EA\u9002\u5E94\u4EAE\u5EA6" },
                window.SP_REACT.createElement(AlsPanel, null)),
            window.SP_REACT.createElement(ErrorBoundary, { title: '手柄灯光' },
                window.SP_REACT.createElement(ControllerLightingPanel, null)),
            window.SP_REACT.createElement(ErrorBoundary, { title: "\u98CE\u6247\u63A7\u5236" },
                window.SP_REACT.createElement(FanPanel, null)),
            window.SP_REACT.createElement(ErrorBoundary, { title: "\u6309\u952E\u6620\u5C04" },
                window.SP_REACT.createElement(RemapButtons, null)),
            window.SP_REACT.createElement(ErrorBoundary, null,
                window.SP_REACT.createElement(OtaUpdates, null))));
    });
    const AppContainer = ({ serverAPI }) => {
    ...
    var index = deckyFrontendLib.definePlugin((serverApi) => {
        ...
        return {
            title: window.SP_REACT.createElement("div", { className: deckyFrontendLib.staticClasses.Title }, "Legion Go \u63A7\u5236\u4E2D\u5FC3"),
            content: window.SP_REACT.createElement(AppContainer, { serverAPI: serverApi }),
            icon: (window.SP_REACT.createElement("img", { src: logo, style: {
                    width: '1rem',
                    filter: 'invert(100%) sepia(0%) saturate(2%) hue-rotate(157deg) brightness(107%) contrast(101%)'
                } })),
            onDismount() {
                clearListener();
            }
