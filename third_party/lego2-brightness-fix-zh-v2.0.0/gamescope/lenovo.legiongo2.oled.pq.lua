...
--
-- Installed by the LeGo2BrightnessFix Decky plugin. PQ output is deliberate:
-- gamma 2.2 makes the hardware backlight work again but caps highlights at the
-- panel's full-field 475 nits, losing the 1100 nit peak that only PQ reaches.
-- The plugin restores brightness control on top of PQ instead.
