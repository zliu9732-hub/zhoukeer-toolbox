...
const App = SP_REACT.memo(({}) => {
    ...
    return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null, !loading && (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
        window.SP_REACT.createElement(DeckySection, null,
            window.SP_REACT.createElement(DeckyRow, null,
                window.SP_REACT.createElement("div", { style: { fontSize: "12px", opacity: 0.7, lineHeight: "1.45" } }, "中文汉化：RenAmamiya · 原插件作者：Aarron Lee")),
            window.SP_REACT.createElement(DeckyRow, null,
                window.SP_REACT.createElement("div", { style: { width: "100%", textAlign: "center", fontSize: "14px", fontWeight: 700, color: "#ffcc66", padding: "4px 0 8px" } }, "RenAmamiya汉化"))),
        window.SP_REACT.createElement(DeckySection, null,
