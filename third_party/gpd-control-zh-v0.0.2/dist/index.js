(function (deckyFrontendLib, React, reactDom) {
	...
	const getLatestVersionNum = async (serverApi) => {
	    const { result } = await serverApi.fetchNoCors('https://raw.githubusercontent.com/aarron-lee/GpdControl/main/package.json', { method: 'GET' });
	    //@ts-ignore
	...
	// off, solid, breathe or rotate
	var RgbModes;
	(function (RgbModes) {
	    RgbModes["OFF"] = "OFF";
	    RgbModes["SOLID"] = "SOLID";
	    RgbModes["BREATHE"] = "BREATHE";
	    RgbModes["ROTATE"] = "ROTATE";
	})(RgbModes || (RgbModes = {}));
	...
	const bootstrapRgbProfile = (state, newGameId) => {
	    ...
	    (!state.rgbProfiles[newGameId] && state.perGameProfilesEnabled) ||
	        ...
	        newGameId === "default") {
	        const defaultProfile = lodash.exports.get(state, "rgbProfiles.default", DEFAULT_RGB_LIGHT_VALUES);
	...
	const useRgbMode = () => {
	    const mode = useSelector(selectRgbMode);
	    const dispatch = useDispatch();
	    const setMode = React.useCallback((mode) => {
	        return dispatch(rgbSlice.actions.setRgbMode({ mode }));
	    }, []);
	    return [mode, setMode];
	};
	...
	(function (Mode) {
	    Mode[Mode["OFF"] = 0] = "OFF";
	    Mode[Mode["SOLID"] = 1] = "SOLID";
	    Mode[Mode["BREATHE"] = 2] = "BREATHE";
	...
	const RgbSettings = () => {
	    ...
	    return (window.SP_REACT.createElement(window.SP_REACT.Fragment, null,
	        window.SP_REACT.createElement(RgbModeSlider, null),
	...
	const ControllerLightingPanel = () => {
	    ...
	    return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: title },
	        ...
	        window.SP_REACT.createElement(RgbSettings, null)));
	};
	...
	const getDeviceNameSelector = (state) => state.ui.deviceName;
	...
	const saveRgbSettings = (store) => {
	    ...
	    const { rgb: { rgbProfiles, perGameProfilesEnabled }, } = store.getState();
	...
	var logo = 'http://127.0.0.1:1337/plugins/GPD 控制中心/assets/Icon-6e8d5086.png';
	...
	const OtaUpdates = () => {
	    ...
	    return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: "\u66F4\u65B0" },
	        window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
	            window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "已安装版本" }, installedVersionNum)),
	        Boolean(latestVersionNum) && (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
	            window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "最新版本" }, latestVersionNum))),
	        Boolean(deviceName) && (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
	            window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "设备名称" }, deviceName))),
	        Boolean(latestVersionNum) && (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
	...
	var index = deckyFrontendLib.definePlugin((serverApi) => {
	    ...
	    return {
	        title: window.SP_REACT.createElement("div", { className: deckyFrontendLib.staticClasses.Title }, "GPD \u63A7\u5236\u4E2D\u5FC3"),
